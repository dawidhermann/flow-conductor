...
export interface PipelineRequestStage<Result> extends BasePipelineStage<Result> {
    config: IRequestConfig | IRequestConfigFactory<Result>;
}
export interface PipelineManagerStage<Result> extends BasePipelineStage<Result> {
    request: RequestFlow;
}
